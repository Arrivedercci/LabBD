...
BEGIN
    FOR i IN 1..10 LOOP
        ...
        CREATE INDEX idx_ind_frequenta_escola_memb_tb_esc ON TB_ESC(ind_frequenta_escola_memb);
        ...
        DROP INDEX idx_ind_frequenta_escola_memb_tb_esc;';


        end_time := clock_timestamp();
        RAISE NOTICE 'Query Index 3, Iteração %: Tempo de execução = %', i, end_time - start_time;
    END LOOP;
END $$;